...
public class StuffVisitRecordFragment extends BaseFragmentPresenter<VisitRecordFragmentView> {
    private StuffVisitRecordAdapter adapter;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        initInject();
        adapter = new StuffVisitRecordAdapter(activity);
