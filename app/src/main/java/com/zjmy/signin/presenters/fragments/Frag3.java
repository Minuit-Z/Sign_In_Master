...
import com.zjmy.signin.presenters.view.Frag3View;
...
public class Frag3 extends BaseFragmentPresenter<Frag3View> {
    private MainActivity activity;

    @Override
    public Class<Frag3View> getRootViewClass() {
        return Frag3View.class;
    }
